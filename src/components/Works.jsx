...
import { section4 } from "../constants";
			...
			>
				<div className="relative w-full h-[230px]">
					...
					<div className="absolute inset-0 flex justify-end m-3 card-img_hover">
						...
						>
							<img
								src={section4.link_icon}
								alt={section4.link_icon_alt}
	...
	return (
		<>
			<motion.div variants={textVariant()}>
				<p className={`${styles.sectionSubText} `}>{section4.subTitle}</p>
				<h2 className={`${styles.sectionHeadText}`}>{section4.title}</h2>
			</motion.div>
